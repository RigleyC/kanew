  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['auth'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'startSignup': _i1.MethodConnector(
          name: 'startSignup',
          params: {
            'email': _i1.ParameterDescription(
              name: 'email',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['auth'] as _i4.AuthEndpoint).startSignup(
                session,
                email: params['email'],
              ),
        ),
        'verifyCode': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['auth'] as _i4.AuthEndpoint).verifyCode(
                session,
                accountRequestId: params['accountRequestId'],
                code: params['code'],
              ),
        ),
        'finishSignup': _i1.MethodConnector(
          name: 'finishSignup',
          params: {
            'registrationToken': _i1.ParameterDescription(
              name: 'registrationToken',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['auth'] as _i4.AuthEndpoint).finishSignup(
                session,
                registrationToken: params['registrationToken'],
                name: params['name'],
                password: params['password'],
        ...
        'resendCode': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['auth'] as _i4.AuthEndpoint).resendCode(
                session,
                email: params['email'],
              ),
        ),
        ...
        'getWorkspaces': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['workspace'] as _i5.WorkspaceEndpoint)
