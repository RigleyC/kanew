...
--
-- Class CardActivity as table card_activity
--
...
--
-- Class CardList as table card_list
--
...
--
-- Class LabelDef as table label_def
--
...
--
-- Class MemberPermission as table member_permission
--
...
--
-- Class PasswordResetToken as table password_reset_token
--
...
ALTER TABLE ONLY "card"
    ...
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "card"
    ADD CONSTRAINT "card_fk_2"
    FOREIGN KEY("assigneeMemberId")
    REFERENCES "workspace_member"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;

--
-- Foreign relations for "card_activity" table
--
...
--
-- Foreign relations for "card_list" table
--
...
--
-- Foreign relations for "label_def" table
--
...
--
-- Foreign relations for "member_permission" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('kanew', '20260211234951523', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260211234951523', "timestamp" = now();
